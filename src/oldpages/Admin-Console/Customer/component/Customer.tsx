...
import CustomerDetailsStep from './tabs/CustomerDetailsStep';
import TaggingStep from './tabs/TaggingStep';
import AlertProfileStep from './tabs/AlertProfileStep';
import ConnectionDetailsStep from './tabs/ConnectionDetailsStep';
import { Box, FormControl, FormControlLabel, Radio, RadioGroup, Step, StepButton, StepContent, StepLabel, Stepper } from '@mui/material';
import ConnectionStep from './tabs/ConnectionStep';
/**
...
function Customer({	handleBreadStep }:any) {
...
// console.log(location.state)
	...
	return (
		<>
			<div className="">
				<Box sx={{ width: '80%', m: 'auto', paddingTop: '30px' }}>
					...
					<div className="m-auto sm:p-24 max-w-3xl content-center text-center">
						{allStepsCompleted() ? (
							<React.Fragment>
