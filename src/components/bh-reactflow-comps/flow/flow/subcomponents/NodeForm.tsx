    ...
    <div className={`flex gap-2 items-center px-1 overflow-visible ${!canDelete ? 'bg-gray-50' : ''}`}>
      <div className="w-1/2">
        <Input
          ...
          className={`w-full focus:ring-2 focus:ring-offset-0 focus:ring-blue-500 ${!canDelete ? 'border-gray-200' : ''}`}
          readOnly={!canDelete}
        />
      </div>
      <div className="w-1/2">
    ...
    return (
      <div className="space-y-3 px-3 overflow-visible">
        ...
        <Button
          ...
          className="w-full mt-4 border border-dashed border-gray-200 hover:border-gray-300 text-gray-600 h-9 px-4"
        >
        ...
        <CardContent className="p-6 space-y-6 overflow-visible">
          ...
          <div className="grid grid-cols-2 gap-4 items-center">
            ...
            <Select value={selectedValue} onValueChange={handleValueChange}>
              <SelectTrigger id="type-select" className="bg-white border-gray-200 hover:border-gray-300 focus:ring-black">
          ...
          <Tabs value={activeTab} onValueChange={handleTabChange} className="w-full overflow-visible">
            <TabsList className={`grid w-full ${hasParameters ? "grid-cols-3" : "grid-cols-2"} mb-3 overflow-visible`}>
              ...
              <TabsTrigger value="settings" disabled={!groupedProperties.settings.length}>Settings</TabsTrigger>
