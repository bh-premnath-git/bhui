...
const SuccessfulDialogueBox = ({ open, handleClose }) => {
  useEffect(() => {
    if (open) {
    ...
    <React.Fragment>
     <Dialog
      ...
      >
        ...
        <Typography sx={{margin:"auto",fontWeight:'bold',mt:'5%'}}>Data published Successfully</Typography>
...
export default SuccessfulDialogueBox;
