...
export default function PipeLinePopUp({ open, handleClose }:any) {
    ...
    const columns: any = generateColumnsFromData(data, ['']);
    ...
    return (
        ...
        >
                    ...
                    <DialogContentText id="alert-dialog-description">
                        <Stack direction={'row'} justifyContent={'space-between'} sx={{ mb: 1 }}>
                            ...
                            <div className="dropdown">
                                <img className="dropdown-toggle" src="/assets/buildPipeline/downArrow.png" alt="" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false" />
                                <ul className="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                    {['CSV', 'Excel', 'JSON'].map((item) => (
                                        <li key={item}><a className="dropdown-item" href="#">{item}</a></li>
                                    ))}
                                </ul>
                            </div>
                        </Stack>
                        <Stack style={{ minWidth: '700px' }}>
            ...
            {isExpanded && (<>
                <Stack style={{ minWidth: '700px' }} sx={{ p: 2 }}>
                    <Stack direction={'row'} justifyContent={'space-between'}>
                        ...
                        <Stack direction={'row'} spacing={2} alignContent={'center'} alignItems={'center'}>
                            ...
                            <div className="dropdown">
                                <img className="dropdown-toggle" src="/assets/buildPipeline/downArrow.png" alt=""
                                    id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false" width={30} />
                                <ul className="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                    {['CSV', 'Excel', 'JSON'].map((item) => (
                                        <li key={item}><a className="dropdown-item" href="#">{item}</a></li>
                                    ))}
