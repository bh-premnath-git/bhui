      ...
      <CardContent className="space-y-8">
        ...
        <div className="space-y-6">
          ...
          <div className="flex items-center space-x-2 pb-2 border-b border-gray-100">
            ...
            <h3 className="font-semibold text-base text-gray-900">Configuration Overview</h3>
          </div>
          ...
          <div className="bg-gradient-to-br from-gray-50 to-gray-100 rounded-xl p-6 border border-gray-300 mb-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="bg-white rounded-lg p-4 border border-gray-200 shadow-sm">
                <label className="text-xs font-medium text-gray-600 uppercase tracking-wide block mb-2">Compute Type</label>
                <Badge variant="secondary" className="bg-gray-800 text-white border-gray-800 text-sm px-3 py-1">
                  {formValues.compute_type}
                </Badge>
              </div>
              <div className="bg-white rounded-lg p-4 border border-gray-200 shadow-sm">
                <label className="text-xs font-medium text-gray-600 uppercase tracking-wide block mb-2">Environment</label>
          ...
          {Object.keys(formValues.compute_config || {}).length > 0 && (
            <div className="bg-gradient-to-br from-gray-50 to-gray-100 rounded-xl p-6 border border-gray-300">
              <div className="flex items-center space-x-2 mb-4">
                ...
                <h4 className="font-semibold text-base text-gray-900">Advanced Parameters</h4>
              </div>
                  ...
                  if (value !== null && value !== undefined && value !== '') {
                    return (
                      <div key={key} className="bg-white rounded-lg p-4 border border-gray-200 shadow-sm">
                        ...
                        <div className="mt-1">
                          {Array.isArray(value) ? (
                            <span className="text-sm text-gray-900 font-medium bg-gray-200 px-2 py-1 rounded">
                              {value.length} items
                            </span>
                          ) : typeof value === 'object' ? (
                            <span className="text-sm text-gray-900 font-medium bg-gray-200 px-2 py-1 rounded">
