...
export default function ValidationComponent({ 
  ...
  // Update parent component about validation state changes
  useEffect(() => {
    onValidationChange?.(validationState)
  }, [validationState, onValidationChange])

  const startValidation = async () => {
    // Reset error state before starting new validation
    ...
    try {
      ...
      setInternalError(!result) // Set error if validation failed
    } catch (error) {
