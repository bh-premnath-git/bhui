...
import DotLoader from "../../../oldcomponents/DotLoader";
/**
 * The Meta-Data app.
 */
...
function OnboardSelectSource(props: any) {
				...
				>
					{({ isValid, isSubmitting }) => (
						<Form>
							...
							{isSubmitting ? <DotLoader /> : <Stack sx={{ margin: 'auto', width: '30%' }}>
								...
								/>
								<Box mt={1} sx={{ color: "red" }}>
									<ErrorMessage name="source_file_path" component="div" />
								</Box>
								<br />
								<br />
								<Stack sx={{ width: '40%', m: 'auto' }}>
									<Button
										type="submit"
										variant="contained"
										disabled={props.isSourceExists || !isValid || isSubmitting} // Disable button based on conditions
										sx={{
											color: "white",
...
export default OnboardSelectSource;