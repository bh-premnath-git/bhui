...
import { fetchTransformationOutput } from "@/store/oldstore/BuildPipeLineSlice";
...
export const CustomEdge = memo(({
    ...
    const { metricsData, isMetricsLoading } = useSelector((state: RootState) => state.buildPipeLine);
